...
bp = Piece('b', 'p', 'c:/chess/icons/b_pawn.png')
wp = Piece('w', 'p', 'c:/chess/icons/w_pawn.png')
bk = Piece('b', 'k', 'c:/chess/icons/b_king.png')
wk = Piece('w', 'k', 'c:/chess/icons/w_king.png')
br = Piece('b', 'r', 'c:/chess/icons/b_rook.png')
wr = Piece('w', 'r', 'c:/chess/icons/w_rook.png')
bb = Piece('b', 'b', 'c:/chess/icons/b_bishop.png')
wb = Piece('w', 'b', 'c:/chess/icons/w_bishop.png')
bq = Piece('b', 'q', 'c:/chess/icons/b_queen.png')
wq = Piece('w', 'q', 'c:/chess/icons/w_queen.png')
bkn = Piece('b', 'kn', 'c:/chess/icons/b_knight.png')
wkn = Piece('w', 'kn', 'c:/chess/icons/w_knight.png')
...
def create_board(board):
    board[0] = [Piece('b', 'r', 'c:/chess/icons/b_rook.png'), Piece('b', 'kn', 'c:/chess/icons/b_knight.png'), Piece('b', 'b', 'c:/chess/icons/b_bishop.png'), \
               Piece('b', 'q', 'c:/chess/icons/b_queen.png'), Piece('b', 'k', 'c:/chess/icons/b_king.png'), Piece('b', 'b', 'c:/chess/icons/b_bishop.png'), \
               Piece('b', 'kn', 'c:/chess/icons/b_knight.png'), Piece('b', 'r', 'c:/chess/icons/b_rook.png')]

    board[7] = [Piece('w', 'r', 'c:/chess/icons/w_rook.png'), Piece('w', 'kn', 'c:/chess/icons/w_knight.png'), Piece('w', 'b', 'c:/chess/icons/w_bishop.png'), \
               Piece('w', 'q', 'c:/chess/icons/w_queen.png'), Piece('w', 'k', 'c:/chess/icons/w_king.png'), Piece('w', 'b', 'c:/chess/icons/w_bishop.png'), \
               Piece('w', 'kn', 'c:/chess/icons/w_knight.png'), Piece('w', 'r', 'c:/chess/icons/w_rook.png')]

    for i in range(8):
        board[1][i] = Piece('b', 'p', 'c:/chess/icons/b_pawn.png')
        board[6][i] = Piece('w', 'p', 'c:/chess/icons/w_pawn.png')
    return board
